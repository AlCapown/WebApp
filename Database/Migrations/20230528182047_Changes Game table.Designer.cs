...
namespace WebApp.Database.Migrations
{
    ...
    [Migration("20230528182047_Changes Game table")]
    partial class ChangesGametable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApp.Database.Tables.User.AppIdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6fa34abf-9fe9-4871-b266-e3ef928569da",
                            Name = "USER",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "7b94084d-41e2-48f9-9b2d-50f5adcdecb6",
                            Name = "ADMIN",
